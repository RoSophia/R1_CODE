...
class ThreeWheelLocalizer(): Localizer{
    ...
    private val LEFT_PARALLEL_OFFSET: Double = 0.0
    private val RIGHT_PARALLEL_OFFSET: Double = 0.0
    private val PERPENDICULAR_OFFSET: Double = 0.0
    ...
    fun update() {
        ...
        val deltaHeading: Double = (deltaRightParallelReading - deltaLeftParallelReading)/23.5
